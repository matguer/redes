...
parser.add_argument("--tabla", action = "store_true", help = "Determina si imprimir el output de la fuente en formato de tabla de latex. (Solo para ej == 2).")
